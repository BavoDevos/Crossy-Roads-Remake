#include "stdafx.h"
#include "SkullUberMaterial.h"

SkullUberMaterial::SkullUberMaterial()
	: Material<SkullUberMaterial>{ L"Effects/UberShader.fx" }
{
}

void SkullUberMaterial::InitializeEffectVariables()
{
